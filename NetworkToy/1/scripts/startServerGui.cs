...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Torque2D/modules/NetworkToy/1/scripts/startServerGui.cs at master · Doc308/Torque2D</title>
...
<meta content="MMv9v95DF3u2n0XMbXK0LW+T51q0S0TON5Ejn7fh/Yo=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-30896c5685c3dd8da766a4fd3065a563107c9370.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="bdd56032babb410898471b4229dd697b">
        ...
        <link data-pjax-transient rel='permalink' href='/Doc308/Torque2D/blob/1fc96a6b6b1b1018952d1a75ddee2bfdf6558798/modules/NetworkToy/1/scripts/startServerGui.cs'>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Doc308/Torque2D/blob/development/modules/NetworkToy/1/scripts/startServerGui.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="development" rel="nofollow" title="development">development</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Doc308/Torque2D/blob/master/modules/NetworkToy/1/scripts/startServerGui.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:e630f105a2eb016847b4eda972fec855 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:e630f105a2eb016847b4eda972fec855 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Doc308/Torque2D/blob/1fc96a6b6b1b1018952d1a75ddee2bfdf6558798/modules/NetworkToy/1/scripts/startServerGui.cs" data-title="Torque2D/modules/NetworkToy/1/scripts/startServerGui.cs at master · Doc308/Torque2D · GitHub" data-type="blob">
              ...
              <div class="actions">
                <div class="button-group">
                        <a class="minibutton tooltipped leftwards"
                           ...
                           href="/Doc308/Torque2D/edit/master/modules/NetworkToy/1/scripts/startServerGui.cs"
                           data-method="post" rel="nofollow">Edit</a>
                  <a href="/Doc308/Torque2D/raw/master/modules/NetworkToy/1/scripts/startServerGui.cs" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Doc308/Torque2D/blame/master/modules/NetworkToy/1/scripts/startServerGui.cs" class="button minibutton ">Blame</a>
                  <a href="/Doc308/Torque2D/commits/master/modules/NetworkToy/1/scripts/startServerGui.cs" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L25" rel="#L25">25</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="n">function</span> <span class="n">startServerGui</span><span class="p">::</span><span class="n">onWake</span><span class="p">(%</span><span class="k">this</span><span class="p">)</span></div><div class='line' id='LC2'><span class="p">{</span></div><div class='line' id='LC3'>&nbsp;&nbsp;&nbsp;<span class="k">if</span><span class="p">(</span><span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">port</span> <span class="err">$</span><span class="p">=</span> <span class="s">&quot;&quot;</span><span class="p">)</span></div><div class='line' id='LC4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">port</span> <span class="p">=</span> <span class="m">28000</span><span class="p">;</span></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;<span class="k">if</span><span class="p">(</span><span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">MaxPlayers</span> <span class="err">$</span><span class="p">=</span> <span class="s">&quot;&quot;</span><span class="p">)</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">MaxPlayers</span> <span class="p">=</span> <span class="m">32</span><span class="p">;</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;<span class="n">startServerName</span><span class="p">.</span><span class="n">setText</span><span class="p">(</span><span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">Name</span><span class="p">);</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;<span class="n">startServerPlayerName</span><span class="p">.</span><span class="n">setText</span><span class="p">(</span><span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Player</span><span class="p">::</span><span class="n">Name</span><span class="p">);</span></div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;<span class="n">startServerPort</span><span class="p">.</span><span class="n">setText</span><span class="p">(</span><span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">port</span><span class="p">);</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;<span class="n">startServerMaxPlayers</span><span class="p">.</span><span class="n">setText</span><span class="p">(</span><span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">MaxPlayers</span><span class="p">);</span></div><div class='line' id='LC13'><span class="p">}</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><span class="n">function</span> <span class="n">startServerGui</span><span class="p">::</span><span class="n">createServer</span><span class="p">()</span></div><div class='line' id='LC16'><span class="p">{</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;<span class="p">%</span><span class="n">serverName</span> <span class="p">=</span> <span class="n">startServerName</span><span class="p">.</span><span class="n">getValue</span><span class="p">();</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;<span class="p">%</span><span class="n">playerName</span> <span class="p">=</span> <span class="n">startServerPlayerName</span><span class="p">.</span><span class="n">getValue</span><span class="p">();</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;<span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Player</span><span class="p">::</span><span class="n">Name</span> <span class="p">=</span> <span class="p">%</span><span class="n">playerName</span><span class="p">;</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;<span class="err">$</span><span class="n">pref</span><span class="p">::</span><span class="n">Server</span><span class="p">::</span><span class="n">Name</span> <span class="p">=</span> <span class="p">%</span><span class="n">serverName</span><span class="p">;</span>  </div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;<span class="n">createServer</span><span class="p">(</span><span class="k">true</span><span class="p">);</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;<span class="n">canvas</span><span class="p">.</span><span class="n">popDialog</span><span class="p">(</span><span class="n">startServerGui</span><span class="p">);</span></div><div class='line' id='LC25'><span class="p">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.12620s from fe1.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
    <a class="left" href="/">
      <span class="mega-octicon octicon-mark-github"></span>
    </a>
    <ul id="legal">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.12666' data-host='fe1'></span>
